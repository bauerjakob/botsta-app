...
import 'package:botsta_app/screens/new_chat_group/new_chat_group_screen_2.dart';
                                    ...
                                    child: BotstaButton(
                                      ...
                                      onTap: () async {
                                        await showCupertinoModalBottomSheet(
                                          ...
                                          context: context,
                                          builder: (context) {
                                            return NewChatGroupScreen2(_selectedPracticants);
                                          },
                                        );
                              ...
                              itemBuilder: (item, index) {
                                ...
                                return Container(
                                  child: UserItem(
                                    ...
                                    selected:
                                        _selectedPracticants.contains(user),
                                  ),
                                );
                              }),
                        ),
